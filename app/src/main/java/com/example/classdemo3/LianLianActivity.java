...
public class LianLianActivity extends AppCompatActivity {
    //游戏难度 1简单 2普通 3困难
    private int level = 1;
    //背景音乐
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_lianlian);
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(LianLianActivity.this, GameActivity.class);  //从MainActivity跳转到GameActivity
                //放入数据
        ...
        rankBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(LianLianActivity.this, RankActivity.class);  //从MainActivity跳转到RankActivity
